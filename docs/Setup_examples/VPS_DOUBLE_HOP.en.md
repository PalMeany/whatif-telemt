...
Installation and configuration are described [here](https://github.com/PalMeany/whatif-telemt/blob/main/docs/Quick_start/QUICK_START_GUIDE.en.md). The third-party [telemt-docker](https://gitlab.com/An0nX/telemt-docker#-quick-start-docker-compose) images package upstream Telemt, not this fork.\
