...
Установка и настройка описаны [здесь](https://github.com/PalMeany/whatif-telemt/blob/main/docs/Quick_start/QUICK_START_GUIDE.ru.md). Сторонние образы [telemt-docker](https://gitlab.com/An0nX/telemt-docker#-quick-start-docker-compose) собирают апстримный Telemt, а не этот форк.\
