...
use crate::fork::web::capability::{derive_capability, encode_token};
...
use crate::config::fork::web::WebBackend as Backend;
...
async fn only_a_rendered_bridge_page_is_counted() {
    use crate::fork::web::metrics::WebMetricsSource;
