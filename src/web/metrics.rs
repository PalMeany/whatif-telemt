...
///
/// The relay registers itself once at start-up; `/metrics` renders the block
/// only when a relay is actually running.
static ACTIVE_RELAY_METRICS: OnceLock<Arc<dyn WebMetricsSource>> = OnceLock::new();
